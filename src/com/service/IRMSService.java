...
public interface IRMSService {
	...
	public boolean updatePortInfo(Map<String,Object> baseMap,Map<String,Object> oldMap,Map<String,Object> nextMap,Map<String,Object> newMap) throws SQLException;
