	...
	<form id="form" method="post" enctype="multipart/form-data"> 
	 <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
               <table cellpadding=3>
                    <tr>
                        <td>品牌：</td>
                        <td><input id="brand" type="text" name="brand" class="easyui-validatebox" required="true"/></td>
                    	<td>类型：</td>
                        <td><input id="type" name="type" type="text" class="easyui-combobox" required="true"/></td>
                    	<td>型号：</td>
                    	<td><input id="modelNo" name="modelNo" type="text"class="easyui-validatebox" required="true" /></td>
                    </tr>
                    <tr>
                    	<td>序列号：</td>
                        <td><input id="seriesNo" name="seriesNo" type="text" class="easyui-validatebox" required="true" /></td>
                        <td>采购时间：</td>
