 ...
 function getData(rows,r,selfPort,nextPort,nextType,ifFree) {
     ...
     <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;">
      <a id="next" class="easyui-linkbutton" href="javascript:void(0);"
                        onclick="next()" style="vertical-align: middle;"> 下一步</a>
      <a id="pre" class="easyui-linkbutton" href="javascript:void(0);"
                        onclick="pre()" style="display: none;vertical-align: middle;" >上一步</a> 	
      <a id="btnUpdate" class="easyui-linkbutton" icon="icon-ok" href="javascript:void(0);" style="display: none" onclick="updatePortInfo()">
                    保存</a> 
       <a id="cancel" class="easyui-linkbutton" icon="icon-cancel" href="javascript:void(0);"
