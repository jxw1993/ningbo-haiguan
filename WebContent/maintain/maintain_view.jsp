...
<body>
	...
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-tip" plain="true" onclick="downloadFile();">网络配置</a>
			<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="openPortInfoWin()">端口配置</a>
			<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cut" plain="true" onclick="openUpateConfigWin()">更改配置</a>
		</div>
		<div>
...
<!-- 			</select> -->
	...
	<div id="portInfoWin" class="easyui-window" title="端口信息" collapsible="false" minimizable="false"
    ...
    <div id="updateConfigWin" class="easyui-window" title="端口信息" collapsible="false" minimizable="false"
        maximizable="false" icon="icon-save"  style="width: 300px; height: 150px; padding: 5px;
        background: #fafafa;">
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
